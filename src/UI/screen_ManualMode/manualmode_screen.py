...
from UI.Popup.my_popup_ask import MyPopupAskPerson
...
class ManualMode(Screen):
    ...
    def empty_recycleview(self, text=CustomizationConfig.no_elements_text):
        data = [{'text': text}]
    ...
    def delete_preview_photo(self):
        self.ids.preview_photo.source = './src/assets/images/default-user-original.png'
